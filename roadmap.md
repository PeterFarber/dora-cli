...
logs  /Users/kirilldubovitskiy/.dora/logs/2025-07-20-20-48-12.log
...
[15:01:29.481] [SOCKET] Sending message through socket: 
 {
  ...
  "content": {
    "type": "output",
    "data": {
      "cwd": "/Users/kirilldubovitskiy/projects/dora/handy-cli",
...
- Pass --local-installation to setup .dora folder locally and avoid clashing with global installation
...
- e2e single tests
  - Would be nice to be able to run the whole thing - including pty to emulate a simple scenario and make sure a single multi step dora path works fine
