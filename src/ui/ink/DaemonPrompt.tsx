...
export const DaemonPrompt: React.FC<DaemonPromptProps> = ({ onSelect }) => {
    ...
    return (
        <Box flexDirection="column">
            <Box marginBottom={1}>
                <Text bold color="cyan">🚀 Dora Daemon Setup</Text>
            </Box>
            
            <Box flexDirection="column" marginBottom={1}>
                <Text>📱 Dora can run a background service that allows you to:</Text>
            ...
            <Box marginBottom={1}>
                <Text>Would you like Dora to start this service automatically?</Text>
            </Box>
