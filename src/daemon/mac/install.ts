/**
 * Installation script for Dora daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the dora command. 
 * 
 ...
 * 2. We assume users will run dora frequently (every time they open their laptop)
...
const PLIST_LABEL = 'com.dora-cli.daemon';
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the dora CLI executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.dora/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.dora/daemon.log</string>
        ...
        logger.info('Check logs at ~/.dora/daemon.log');
